...
const GOAL_META: Record<GoalType, {
  ...
  MAX_DRAWDOWN:       { label: "Max Drawdown Limit",    description: "The maximum drawdown % you allow before stopping.", suffix: "%", icon: TrendingDown },
  WIN_RATE:           { label: "Win Rate Target",       description: "The win rate % you are aiming to maintain.", suffix: "%", icon: Activity },
    ...
    <main className="flex-1 px-4 py-6 sm:px-8 sm:py-8 space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold tracking-tight">Profit Goals</h1>
          <p className="text-sm text-muted-foreground">Set your monthly targets. Progress is tracked in Performance and Dashboard.</p>
        </div>
