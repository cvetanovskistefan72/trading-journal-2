...
function CustomTooltip({ active, payload }: { active?: boolean; payload?: { value: number; payload: HoldBucket }[] }) {
  ...
  return (
    <div style={{
      ...
      color: "var(--color-foreground)", lineHeight: "1.6",
    }}>
